    ...
    <div class="user-detail">
      ...
      <div class="user-info">
        ...
        <div class="github">
          ...
          <a target="_blank" :href="'https://github.com/'+userDetailData.githubUsername">@{{userDetailData.githubUsername}}</a>
        </div>
      ...
      <div class="replies">
        ...
        <ul class="reply-lists" v-if="userDetailData.recent_replies.length">
          <li v-for="item in userDetailData.recent_replies">
            <article-card :article="item" :simpleMode="true"></article-card>
          </li>
        </ul>
        <p class="no-content" v-if="!userDetailData.recent_replies.length">无话题</p>
      </div>
    </div>
  </div>
</template>
