<template>
  <div class="publish-wrap">
    ...
    <div class="publish">
      <div class="new-title">
        <h2>文章标题</h2>
        <input class="title" ref="title" name="title" placeholder="请输入标题，不少于5个字符" type="text">
        <br>
      </div>
      <div class="new-tab">
        <h2>文章类型</h2>
      ...
      <div class="new-content">
        <h2>文章内容</h2>
        <textarea class="content" name="content" placeholder="请在此输入内容" ref="content"></textarea>
        <br>
      </div>
      <button @click="publishArticle" class="publish">发布
